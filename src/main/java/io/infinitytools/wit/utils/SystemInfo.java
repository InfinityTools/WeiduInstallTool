...
import io.infinitytools.wit.process.ProcessUtils;
...
public class SystemInfo {
  ...
  public enum Architecture {
    ...
    /**
     * Returns whether the architecture is supported by the WeiDU tool.
     */
  ...
  /**
   * Returns whether the current system is supported by the WeiDU tool.
   */
