...
import io.infinitytools.wit.WeiduInstallTool;
...
public class R {
   ...
   */
  private static final String BUNDLE_PREFIX = "l10n/wit";
  ...
  public static ResourceBundle getBundle() {
    if (bundle == null) {
      ...
      bundle = ResourceBundle.getBundle(BUNDLE_PREFIX, currentLocale, WeiduInstallTool.class.getModule());
    }
    return bundle;
  }
